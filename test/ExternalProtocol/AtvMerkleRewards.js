    ...
    context('Basic checks for deposit and withdraw', () => {
        describe('Product 401 - stables', async () => {
            ...
            async function fetchMorphoRewards(userAddress) {
                ...
                const apiUrl = 'https://api.merkl.xyz/v3/userRewards?chainId=146&user=0x732D2A5aE6576775c9edf9877bd03B5567e75094&proof=true'
            ...
            beforeEach(async () => {
                ...
                */
                ...
                await aFiPassiveRebalanceInstance.connect(investor1).setDexForTokenPair("0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38", "0x29219dd400f2Bf60E5a23d13Be72B486D4038894", 1);
                ...
                console.log("funded account balance usdttttttttt", aTokenConInstance1.address)
            ...
            it('401', async () => {
                ...
                // Call the function
                const data =  await fetchMorphoRewards(aTokenConInstance1.address)
                ...
                morphoRewardData = {
                    rewardTokens: ["0x6C5E14A212c1C3e4Baf6f871ac9B1a969918c131"],
                    underlyingTokens : ["0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38"],
                    proofs: [[
                        '0xb67c47fd9245c245cd6b971a9400c8687f6acdb6291b2c45ab37cc94958b188f',
                        '0x19ea9bb933955f1c80e62efd6ec99fc351c37e574a2745ec92fefdf0b519b5e3',
                        '0x393f745baa2fa978c127786a6215267123061dde9238eb1350ebc8656b71b261',
                        '0xe91fc373e3b88c8aa5fccbdd01485b05a41acf49f498ea7153a514025f086da4',
                        '0x48e489e73c780e7e6437d1a2ef9df87f5a80ab4f85d73e4d1e0b837018a6d7d2',
                        '0x3a747e5cbe49a3ed68f34fd900f56c0982c89cecd24d42008da2dfee0501fc00',
                        '0xad0956eab803ecd20662634655674f8541ea08db372bfa56b9eea6221506b4fd',
                        '0x27ed5f582572cb31f6e86541fa25c1ac4e230dbc8e27c8503d7ced294c920d88',
                        '0xe312a224bc3b498c3bafb8809613415bc59209a3b7463c6884aa7733a0474e89',
                        '0xd9ba0af68fa2b9eda35f0bd862fe57fdc221b911d359f0e6bad2d9d4ce0e9fe1',
                        '0x62c5a3eb18c76c4aa90f67d6c6dbeced65bd9030b4719e8afe447c713402df0e',
                        '0xfd625fb1ed62288cc397e3cbfbf37f4da9d5f1a5e637ba31e32284816e0091a2',
                        '0x1a92cd6bea0b08e14aff8b72afbaf1e3922609da2fed37d22e2d74d901b47544',
                        '0x5c94d4d89114738a32ffbc257847992343f4a694d96582a2bfb329aaa9c2b466',
                        '0xb7f3df71cdb1c6a8f08e00163682bf3910b094e6c9aceefc35738f8490d01ebc',
                        '0xec848e004d09f7d585c8c0722da8cbcebe2371e8f4f30b2b12d4b4b7cc58cfbc'
                      ]],
                    rewardTokenAmount:["142387762503957476"],
                    minReturnAmounts: [0],
                    swapData: [pendleSwapData.transactionData]
                  };
                await aTokenConInstance1.connect(investor1).pauseUnpauseDeposit(true);
                ...
                await aTokenConInstance1.connect(investor1).withdraw(
                    197801111576383300n, usdcConInstance.address, deadline, returnString, 3, 10000000, "0x", 1
                );
