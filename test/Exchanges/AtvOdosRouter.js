...
describe('AFiBase', () => {
    ...
    beforeEach(async () => {
        ...
        wethConInstance = await ethers.getContractAt(USDC_ABI, "0x50c42dEAcD8Fc9773493ED674b675bE577f2634b");
    ...
    context('Basic checks for deposit and withdraw', () => {
        describe('Product 401 - stables', async () => {
            beforeEach(async () => {
                const payload = [
                    [
                        ...
                        "0x50c42dEAcD8Fc9773493ED674b675bE577f2634b", // USDC
                ...
                const payloadnew = [
                    ...
                    [
                        //"0xAed0c38402a5d19df6E4c03F4E2DceD6e29c1ee9",
                        "0x824364077993847f71293B24ccA8567c00c2de11",
                        //"0x3E7d1eAB13ad0104d2750B8863b489D65364e32D"
                    ],
                    ["10000000"],
                    [
                ...
                result = await aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload2, [investor1.address, investor2.address], true, aFiStorageInstance.address,
                    aFiPassiveRebalanceInstance.address, aFiManagerInstance.address, ["0x29219dd400f2Bf60E5a23d13Be72B486D4038894"], "0x0000000000000000000000000000000000000000");
                ...
                */
                ...
                //         "0xCfD41dF89D060b72eBDd50d65f9021e4457C477e",  // pool USDC - WETH
                ...
                //         // ]],
                //          [[
                //             "0xCfD41dF89D060b72eBDd50d65f9021e4457C477e", // pool USDC-WETH (Stables- I/O tokens)
                ...
                await aFiPassiveRebalanceInstance.setDexForTokenPair("0x29219dd400f2Bf60E5a23d13Be72B486D4038894", "0x50c42dEAcD8Fc9773493ED674b675bE577f2634b", 1);
                await aFiPassiveRebalanceInstance.setDexForTokenPair("0xf1ef7d2d4c0c881cd634481e0586ed5d2871a74b", "0x29219dd400f2Bf60E5a23d13Be72B486D4038894", 1);
                ...
                await aFiAFiOracleInstance.connect(investor1).setMarketForToken(aTokenConInstance1.address, "0x29219dd400f2Bf60E5a23d13Be72B486D4038894", "0x3F5EA53d1160177445B1898afbB16da111182418")
            ...
            it('401', async () => {
                ...
                const pathDefinition = await getPathDefinition(
                    "0x29219dd400f2Bf60E5a23d13Be72B486D4038894",
                    99000000,
                    "0x50c42dEAcD8Fc9773493ED674b675bE577f2634b",
                    aTokenConInstance1.address
                ...
                //     193089435654152,
                //     "0x29219dd400f2Bf60E5a23d13Be72B486D4038894",
                //     "0x196aF53d9AAc0ee646c0A7dE53b4A3a7cD40278E"
                // );
                

                console.log("pathDefinition.transactionData", pathDefinition.transactionData);
                oneInchParam = {
                    ...
                    secondIterationCumulativeSwap: [pathDefinition.transactionData]
                }
                console.log("weth before balance", await wethConInstance.balanceOf(aTokenConInstance1.address));
                const swapParams = {
                    ...
                    underlyingTokens: ["0x50c42dEAcD8Fc9773493ED674b675bE577f2634b"],
                ...
                console.log("weth after balance", await wethConInstance.balanceOf(aTokenConInstance1.address));

                let pendleTokenBalance = await ethers.getContractAt(USDC_ABI, "0x50c42dEAcD8Fc9773493ED674b675bE577f2634b");
                const pendleBalance = await pendleTokenBalance.balanceOf(aTokenConInstance1.address);
                console.log(`pendleBalance token balance : ${ethers.utils.formatUnits(pendleBalance, 0)}`);
                ...
                await aFiAFiOracleInstance.swapRewardsToStable(aTokenConInstance1.address, USDC_ADDRESS, USDC_ADDRESS, [pendleSwapData.transactionData, "0x"], [0,0]);
                ...
                // //     197801111576383300n, usdcConInstance.address, deadline, returnString, 3, 10000000
                // // );
