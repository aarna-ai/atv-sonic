    ...
    context('Basic checks for deposit and withdraw', () => {
        ...
        describe('Product 401 - stables', async () => {
            beforeEach(async () => {
                ...
                const payloadnew = [
                    ["0xdAC17F958D2ee523a2206206994597C13D831ec7"], //USDT, USDC - payment tokens
                    ["0x3E7d1eAB13ad0104d2750B8863b489D65364e32D"], // USDT, USDC - chainlink oracles
                    uDataPayload,
                    [
                ...
                const bytesPayload2 = await aFiFactoryInstance.encodePoolData(payloadnew);
                console.log("USDT payload", bytesPayload2);
                result = await aFiFactoryInstance.createAToken("AFiBase", "ATOK", bytesPayload2, [investor1.address, investor2.address], true, aFiStorageInstance.address,
                ...
                await aFiPassiveRebalanceInstance.intializeStalePriceDelay(["0xdAC17F958D2ee523a2206206994597C13D831ec7"
            ], [
                    86500
                ])
                ...
                */
                ...
                const unipooldata = await aFiPassiveRebalanceInstance.encodePoolData(poolPayload)
                await aFiPassiveRebalanceInstance.initUniStructure(["0xdAC17F958D2ee523a2206206994597C13D831ec7"], unipooldata);
            ...
            it('401', async () => {
                ...
                const swapParams = {
                    ...
                    newProviders: [3], // Fill this with the new providers' information
                    _deadline: deadline,
                    cometToClaim: ["0x3Afdc9BCA9213A35503b077a6072F3D0d5AB0840"],
                ...
                let usdcaaveBalance = await aFiStorageInstance.balanceAave(usdtConInstance.address, aTokenConInstance1.address);
                console.log("usdcaaveBalance----------", usdcaaveBalance);

                usdcaaveBalance = await aFiStorageInstance.balanceCompound(usdtConInstance.address, aTokenConInstance1.address);
                console.log("usdcaaveBalance----------", usdcaaveBalance);

                usdcaaveBalance = await aFiStorageInstance.balanceCompV3(usdtConInstance.address, aTokenConInstance1.address);
                console.log("usdcaaveBalance----------", usdcaaveBalance);
