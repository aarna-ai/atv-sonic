...
describe('AFiBase', () => {
    ...
    beforeEach(async () => {
        ...
        aFiDexAdapterV2Instance = await AFiDexAdapterV2.deploy("0xE592427A0AEce92De3Edee1F18E0157C05861564", "0x111111125421cA6dc452d289314280a0f8842A65" ,aFiPassiveRebalanceInstance.address);
        console.log("aFiDexAdapterV2Instance-------", aFiDexAdapterV2Instance.address);
        ...
        */
        ...
        await aTokenConInstance.setDexAdapter(aFiDexAdapterV2Instance.address);
    });
